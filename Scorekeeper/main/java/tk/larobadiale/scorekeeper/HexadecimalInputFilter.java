...
/**
 * Created by Scott A Dixon (https://gist.github.com/scottdarch/bdd9a7abebd1bf6dc9b8).
 */
...
//public class InputFilterHexadecimal implements InputFilter {
//    @Override
//    public CharSequence filter(CharSequence source, int start, int end, Spanned dest, int dstart, int dend) {
...
//        }
//
//        if (sum == input.length() && input.length() <= 8) {
//            return true;
//        } else {
//            return false;
//        }
